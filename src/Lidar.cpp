...
//					std::cout << "angle: " << Utils::MathUtils::toRadians(angle) << " distance: " << distance << std::endl;
//					distanceStimuli.stimuli.push_back(DistanceStimulus( Utils::MathUtils::toRadians(angle),distance));
//					}else{
...
//			std::cout << "uuuuuuuuuuuuuuuuuuuuuuuuuuuuuhhhhhhhhhhh" << std::endl;
...
//					std::cout << "oooooooooooooooooooooooooooooooooooooooook" << std::endl;
					if(distanceStimulus.distance != noDistance)
					{
//						distancePercepts.pointCloud.push_back(DistancePercept(wxPoint(noObject,noObject)));
//						std::cout << "yeah sureeeeeeeeeeeeeeeeeeeeeeeeee" << std::endl;
